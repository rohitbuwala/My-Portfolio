...
const services = [
  {
    icon: <Globe size={28} className="text-neon-blue" />,
  ...
  {
    icon: <Calendar size={28} className="text-neon-blue" />,
  ...
  return (
    <section id="what-i-build" className="py-20 md:py-32 relative">
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-40 left-20 w-72 h-72 bg-neon-purple/10 rounded-full filter blur-3xl"></div>
      </div>
